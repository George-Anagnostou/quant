...
- `src/quant/dashboard/services.py` adapts shared Polars analysis for the API. `src/quant/user_data.py` owns user-scoped portfolio accounts, lots, cash, and audited mutations; FastAPI routes must not read or write persistence directly.
